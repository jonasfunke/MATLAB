        ...
        %generate a list of images to be read from the movie
         ...
         function [img] = readFrame(obj,framenumber)
              if obj.input == 1 % tif
                    ...
                    img = fitsread([obj.pname obj.fname],  'Info', obj.info, 'PixelRegion',{[1 obj.sizeX], [1 obj.sizeY], [framenumber framenumber] });  % fits               
              end
         end
         ...
         function [h_min ] = get_h_min(obj, r_find)
            ...
            p = find_peaks(img, r_find*2, min(img(:)), 0); % finding all possible peaks p has x, y, height, height-bg, I, I-I_bg
